...
> **Agente de IA?** Abra [**llms-install.md**](https://unpkg.com/awesome-gpt-image-api-proxy-skills@latest/llms-install.md) para instruções de instalação feitas para agentes.
