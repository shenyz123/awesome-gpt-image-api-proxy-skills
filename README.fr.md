...
> **Agent IA ?** Ouvrez [**llms-install.md**](https://cdn.jsdelivr.net/npm/awesome-gpt-image-api-proxy-skills@latest/llms-install.md) pour les étapes d’installation conçues pour les agents.
