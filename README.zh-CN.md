...
> **AI Agent?** 可跳过 README，直接阅读 [**llms-install.md**](https://unpkg.com/awesome-gpt-image-api-proxy-skills@latest/llms-install.md) 获取面向 Agent 的安装步骤。
...
完整端点、payload、结果和输出说明见 [references/api-params.md](https://unpkg.com/awesome-gpt-image-api-proxy-skills@latest/references/api-params.md)。
...
- 技能定义：[SKILL.md](https://unpkg.com/awesome-gpt-image-api-proxy-skills@latest/SKILL.md)
- Agent 安装指南：[llms-install.md](https://unpkg.com/awesome-gpt-image-api-proxy-skills@latest/llms-install.md)
- API 参考：[references/api-params.md](https://unpkg.com/awesome-gpt-image-api-proxy-skills@latest/references/api-params.md)
